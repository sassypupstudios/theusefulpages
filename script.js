...
function injectNav(activeUrl){
  if(!document.querySelector('link[rel="icon"]')){const fav=document.createElement('link');fav.rel='icon';fav.href='/favicon.svg';fav.type='image/svg+xml';document.head.appendChild(fav);}
